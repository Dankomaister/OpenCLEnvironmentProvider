...
__kernel void neighbor_list_double(__global double3 *scaled_positions, __global double3 *offset, __global int *neighborhood_idx,
...
__kernel void neighbor_list_float(__global float3 *scaled_positions, __global float3 *offset, __global int *neighborhood_idx,
